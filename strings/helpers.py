...
HELP_16 = """
<b><u>ᴍᴜsɪᴄ ᴄʟᴏɴᴇ ғᴇᴀᴛᴜʀᴇ</b></u>

1.ғɪʀsᴛ ɢᴏ @Botfather ᴀɴᴅ sᴛᴀʀᴛ. 
2. sᴇɴᴅ /newbot ᴀɴᴅ ɢɪᴠᴇ ʏᴏᴜʀ ʙᴏᴛ ɴᴀᴍᴇ.
3. sᴇɴᴅ ʙᴏᴛ ᴜsᴇʀɴᴀᴍᴇ _bot sᴇʀɪᴇs.
4. ᴄᴏᴘʏ ʏᴏᴜʀ ʙᴏᴛ ᴛᴏᴋᴇɴ ɪɴ ᴏɴᴇ ᴛᴀᴘ. 
5. ʀᴇᴛᴜʀɴ ғᴏʀᴍ ʙᴏᴛ ғᴀᴛʜᴇʀ ᴀɴᴅ ᴇɴᴛᴇʀᴇᴅ @BlossomXMusicBot ʙᴏᴛ.
6. sɪᴍᴘʟʏ sᴇɴᴅ /clone {your bot token} ᴀɴᴅ ᴍᴀᴋᴇ ᴏᴡɴ ᴍᴜsɪᴄ ʙᴏᴛ ᴀɴᴅ ᴇɴᴊᴏʏ.
"""
